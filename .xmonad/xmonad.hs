...
--
myWorkspaces    = ["dev","www","chat","games","media","other", "vm", "8", "9"]
...
--
myLayout = spacingRaw False (Border 0 10 10 10) True (Border 10 10 10 10) True $ avoidStruts (smartBorders (tiled ||| Mirror tiled ||| Full))
  where
...
myManageHook = composeAll
    ...
    , className =? "discord"	    --> doF(W.shift(myWorkspaces !! 2))
    , className =? "Steam"	    --> doF(W.shift(myWorkspaces !! 3))]
...
--
main = do
     xmproc <- spawnPipe "xmobar -x 0 /home/piwalker/.config/xmobar/xmobarrc"
     xmproc2 <- spawnPipe "xmobar -x 1 /home/piwalker/.config/xmobar/xmobarrc"
     xmonad $ docks $ ewmh def {
      ...
      -- hooks, layouts
        ...
        logHook            = dynamicLogWithPP $ xmobarPP { ppOutput = \x -> hPutStrLn xmproc x >> hPutStrLn xmproc2 x },
